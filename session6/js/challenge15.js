...
function display_default() {
    ...
    const url1 = "http://krazywoman.com/krazymlbb/api/hero/read.php";

    const url2 = `https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=Akai-gameplay&type=video&key=${YOUTUBE_API_KEY}`

    let xhr1 = new Promise((resolve, reject) => { 
    ...
    let xhr2 = new Promise((resolve, reject) => { 
        const xhr = new XMLHttpRequest(); 
    ...
    Promise.all([xhr1, xhr2]).then((values) => {
        const heroes = values[0].records;
        const videoId = values[1].items[0].id.videoId;
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body mx-auto">
                                            <iframe id="iframe_${hero.id}" width="560" height="315" src="https://www.youtube.com/embed/${videoId}" frameborder="0" 
